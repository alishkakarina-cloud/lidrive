...
const FAQ = [
  ...
  { q: "Можно ли установить аксессуары, купленные у вас?", a: "Конечно. Установку аксессуаров из каталога LI DRIVE выполняют наши специалисты." },
...
export default function ServicePage() {
  return (
    <>
      ...
      <Wrap>
        <BookingCta title="Запишитесь в сервис LI DRIVE" text="Работаем ежедневно с 09:00 до 21:00. Бишкек, ул. Киевская 123 (ТЦ Asia Mall)." />
      </Wrap>
      <div className="pb-16" />
    </>
  );
